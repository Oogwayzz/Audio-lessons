...
export function ModuleCard({ module, moduleSlug, weeks, lessons }: Props) {
  ...
  if (!href) {
    return (
      <div className="rounded-2xl border border-neutral-200 bg-white p-4 opacity-70 shadow-sm">
        ...
        <div
          aria-disabled
          className="mt-3 inline-flex items-center gap-2 rounded-lg border border-neutral-200 bg-neutral-50 px-2 py-1 text-sm text-neutral-400"
        >
          <span>Open</span>
